...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">รายงานสรุปผลการปฏิบัติงานของตนเอง</h1>
...
<div class="row">
    <div class="col-lg-12">
        <p id="breadcrumb">
            ...
            รายงานสรุปผลการปฏิบัติงานของตนเอง
        </p>
    </div>
</div>
                                ...
                                <tbody>
                                    ...
                                    if ($_POST['st_date'] != '' && $_POST['ed_date'] != '') {
                                        $sql = "SELECT * FROM tb_repair_list WHERE date_input between '" . $_POST['st_date'] . " 00:00:00' and '" . $_POST['ed_date'] . " 23:59:59'  ORDER BY date_input DESC";
                                            ...
                                            "ON a.id = b.repair_id ".
                                            "WHERE a.staff_id = ".$_SESSION['user_id'] . " AND date_input between '" . $_POST['st_date'] . " 00:00:00' and '" . $_POST['ed_date'] . " 23:59:59' ".
