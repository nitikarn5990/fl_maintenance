...
<div class="row">
    <div class="col-lg-12">
        <p id="breadcrumb">
            ...
            รายงานจำนวนการใช้งานของแต่ละประเภท
        </p>
    </div>
</div>
                                    ...
                                    if (mysql_num_rows($res_cat) > 0) {
                                        ...
                                        while ($row = mysql_fetch_assoc($res_cat)) {
                                            ...
                                            <tr class="" >
                                                ...
                                                <td class="center"><a href="<?=ADDRESS?>report_borrow_total_use_detail&cat_id=<?=$row['id']?>" class="btn btn-primary f-12">ดูข้อมูล</a></td> 
